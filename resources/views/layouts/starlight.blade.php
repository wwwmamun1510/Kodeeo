...
<html lang="en">
  <head>
    ...
    <title>Kodeeo - @yield('title')</title>
  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{url('/add/product')}}" class="nav-link">Add Products</a></li>
        </ul>
        ...
        <ul class="sl-menu-sub nav flex-column">
        <li class="nav-item"><a href="{{route('color.size')}}" class="nav-link">Add Color & Size</a></li>
        </ul>
