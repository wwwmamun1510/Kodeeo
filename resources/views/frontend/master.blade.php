            ...
            <div class="container position-relative">
                <div class="row">
                    <div class="col-auto align-self-center">
                        ...
                        <a href="{{ route('welcome') }}"><img src="{{ asset('frontend_assets/images/logo/logo.png')}}" alt="Site Logo" /></a>
                        </div>
                    </div>
                                    ...
                                    <ul class="mega-menu d-block">
                                        <li class="d-flex">
                                            ...
                                            <ul class="d-block">
                                                ...
                                                <li><a href="{{ route('login_register') }}">Login & Register Page</a></li>
                                            </ul>
                                            <ul class="d-block">
                    ...
                    <div class="col col-lg-auto align-self-center pl-0">
                        <div class="header-actions">
                            @auth('customerlogin')
                            <a class="text-wrap" href="{{route('profile')}}">{{ Auth::guard('customerlogin')->user()->name }}</a>
                            @else
                            <a href="{{route('login_register')}}">Sign In</a>
                            @endauth
                            <!-- Single Wedge Start -->
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                   ...
                   <li>
                          <a href="{{route('product.details', $cart->product_id) }}" class="image"><img src="{{asset('uploads/products/preview')}}/{{$cart->rel_to_product->product_image}}"
                           alt="Cart product Image"></a>
                            <div class="content">
                            <a href="{{ route('product.details', $cart->product_id) }}" class="title">{{ $cart->rel_to_product->product_name }}</a>
                            <span class="quantity-price">{{ $cart->quantity }} x <span class="amount">{{ $cart->rel_to_product->product_price }}</span></span>
